package com.cloudpicture.backend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private static final String DATABASE_NAME = "lijinan_picture"; // 配置文件中的数据库名称
    ...
    private void updateShardingTableNodes() {
        ...
        // lijinan_picture.picture_112321321,lijinan_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "lijinan_picture." + tableName) // 确保前缀合法
